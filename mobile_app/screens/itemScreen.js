        ...
        <View style={styles.destination_Container}>
            ...
            <View style={styles.destination_Content} >
                ...
                <View style={{ position: 'absolute', bottom: 10, width: '100%' }}>
                    {showModal && <SaveList handleCloseModal={handleCloseModal} />}
                    <TouchableOpacity style={styles.BookButton} onPress={handleshowModal}>
                        <Text style={{ fontSize: wp(5.5), color: '#FFFFFF', fontWeight: 'bold' }}>Save To the Plan</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
