...
export default function FeaturedRow({ title, rating, description, location,imageSrc }) {
  return (
    ...
    <Text style={{maxWidth: 150,}}  numberOfLines={1} ellipsizeMode="tail"> {location}</Text>
            </View>
          </View>
        </View>
      </View>
